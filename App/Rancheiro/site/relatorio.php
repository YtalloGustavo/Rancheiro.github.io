        ...
        <div id="relatorio-container" class="container-grande margem-topo-5">
            ...
            <div id="content" class="relatorio-conteudo">
                <div class="botoes">
                    ...
                    <a class="botao" href="http://localhost/orancheiro/App/Rancheiro/site/relatorioQuantitativo.php"> Relátorio Quantitativo  </a>
                ...
                function exibirRelatorioPorCompanhia($conn, $idCompanhia, $nomeCompanhia)
                {
                    ...
                    $sqlSargento = "SELECT postoGraduacao, nomeDeGuerra, statusUsuario, idCompanhia FROM usuario WHERE postoGraduacao IN ('Sargento','Sub-tenente')";
                    ...
                    IN ('Aspirante a Oficial', 'Tenente', 'Capitão', 'Major', 'Tenente-Coronel', 'Coronel', 'General')";
