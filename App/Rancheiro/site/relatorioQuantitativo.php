    ...
    <div>
        ...
        <div id="relatorio-container" class="container-grande margem-topo-5">
            ...
            <h1 class='text-center'>$nomeCompanhia</h1>
                    ...
                    $sqlSoldadoCabo = "SELECT COUNT(*) as total FROM usuario WHERE postoGraduacao IN ('Soldado', 'Cabo') AND idCompanhia = $idCompanhia";
                    ...
                    $sqlSargento = "SELECT COUNT(*) as total FROM usuario WHERE postoGraduacao IN ('Sargento', 'Sub-tenente') AND idCompanhia = $idCompanhia";
                    ...
                    $sqlOficiais = "SELECT COUNT(*) as total FROM usuario WHERE postoGraduacao IN ('Aspirante a Oficial', 'Tenente', 'Capitão', 'Major', 'Tenente-Coronel', 'Coronel', 'General') AND idCompanhia = $idCompanhia";
                    ...
                    // Exibe os resultados
                    echo "<h2 class='margem-topo-5'>Total de Soldados e Cabos</h2>";
                    echo "<p>$totalSoldadoCabo</p>";

                    echo "<h2 class='margem-topo-5'>Total de Sargentos / Sub-Tenentes</h2>";
                    echo "<p>$totalSargentoSub</p>";

                    echo "<h2 class='margem-topo-5'>Total de Oficiais</h2>";
