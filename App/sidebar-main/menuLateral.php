<nav id="sidebar">
    <div id="sidebar_content">
        ...
        <ul id="side_items">
            ...
            <li class="side-item">
                <a href="../site/listaDeCardapios.php">
                    <i class="fa-solid fa-person-military-to-person"></i>
                    <span class="item-description">Cardapios Cadastrados</span>
                </a>
            </li>

            <li class="side-item">
                <a href="../site/cadRancho.php" id="cadastroEscala">
                    <i class="fa-solid fa-person-military-rifle"></i>
                    <span class="item-description">Arranchar</span>
                </a>
            </li>
